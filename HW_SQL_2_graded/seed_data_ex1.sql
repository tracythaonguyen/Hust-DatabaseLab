...
CREATE TABLE student(
  snum BIGINT NOT NULL PRIMARY KEY,
  name VARCHAR(50) NOT NULL,
  major VARCHAR(50) NOT NULL,
  level VARCHAR(50) NOT NULL
  CHECK(level IN ('undergraduate', 'graduate', 'professional')),
  age BIGINT
);
...
INSERT INTO faculty_member (fidf, name, dept) VALUES (24, 'Dyann Ruffle', 'Education');
